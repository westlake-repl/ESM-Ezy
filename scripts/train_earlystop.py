...
def parse_args():
    ...
    parser.add_argument('--patience', type=int, default=10, help='Number of epochs to wait before early stop')
...
if __name__ == '__main__':
    ...
    patience = args.patience  # Patience value for Early Stop
    ...
    # ==================== Early Stop Final Report ====================
    print(f"\nTraining completed! Best test accuracy: {best_acc:.4f} at epoch {best_epoch}")